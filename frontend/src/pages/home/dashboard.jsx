    ...
    <DashboardLayout>
      <div className="container mx-auto pt-4 pb-4">
        <div className="flex items-center justify-between px-4 md:px-0 pb-6">
          ...
          {/* Search bar */}
          <div className="w-[583px] h-[52px] bg-white rounded-full shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] 
                          outline outline-1 outline-offset-[-0.50px] outline-gray-300 
                          inline-flex items-center gap-2 overflow-hidden px-4 py-3">
            ...
            <input
              ...
              className="flex-1 bg-transparent border-none outline-none text-gray-700 
                        text-base font-normal leading-none placeholder-gray-400"
            />
            {searchQuery && (
              <IoClose
