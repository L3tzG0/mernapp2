  ...
  return (
    ...
    <div className="w-full min-h-full bg-[#FFFCEF]">
      ...
      <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
        ...
        <header className="flex justify-between items-center mb-16">
          <div className="text-xl text-black font-bold">StudyPal</div>
          {user ? (
            <ProfileInfoCard/>
          ) : (<button
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
            <div className="flex items-center justfy-left mb-2">
            ...
            <h1 className="text-5xl text-black font-medium mb-6 leading-tight">
              Expand your knowledge with <span className="text-transparent bg-clip-text bg-[radial-gradient(circle,_#FF9324_0%,_#FCD760_100%)] bg-[length:200%_200%] animate-text-shine font-semibold">
                AI-powered</span> learning
            </h1>
          </div>
    ...
    <div className="w-full min-h-full relative z-10 bg-[#FFFCEF]">
      ...
      <div className="w-full min-h-full bg-[#FFFCEF] mt-10">
        <div className="contianer mx-auto px-4 pt-10 pb-20">
